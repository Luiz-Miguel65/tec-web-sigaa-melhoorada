# Projeto SIGAA – Interface Moderna e Amigável

Este repositório contém uma **proposta de versão mais moderna e amigável do site SIGAA** (Sistema Integrado de Gestão de Atividades Acadêmicas), focada na experiência dos alunos da UFC. A interface é pensada para melhorar a usabilidade, visual e interação do usuário, refletindo princípios de design estudados em pesquisas recentes.

O desenvolvimento deste projeto tem como base o artigo:
...
- Seções organizadas para fácil leitura e navegação
- Cards interativos para acesso rápido às áreas do SIGAA
- Avisos importantes destacados
- Navegação com setas para interação contextual
- Design com foco na experiência do usuário (UX)
